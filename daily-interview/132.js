// https://github.com/Advanced-Frontend/Daily-Interview-Question/issues/257
...
class Dialog {
    ...
    handleMousemove(e) {
        if (this.isMoving) {
            this.dialog.style.transform = `translate(${e.clientX - this.x + this.lastX}px, ${e.clientY - this.y + this.lastY})`
        }
    }
    handleMouseup(e) {
